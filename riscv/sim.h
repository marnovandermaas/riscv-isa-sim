...
public:
  sim_t(const char* isa, size_t _nprocs, size_t _nenclaves,  bool halted, reg_t start_pc,
        ...
        unsigned progsize, unsigned max_bus_master_bits, bool require_authentication, icache_sim_t **ics, dcache_sim_t **dcs, l2cache_sim_t *l2, l2cache_sim_t **rmts, l2cache_sim_t **static_llc, reg_t num_of_pages, reg_t sender_base);
  ~sim_t();
