...
{
public:
  processor_t(const char* isa, simif_t* sim, uint32_t id, enclave_id_t e_id, struct page_tag_t *tag_directory, size_t num_of_pages, bool halt_on_reset=false);
  ~processor_t();
...
private:
  ...
  struct page_tag_t *tag_directory;
  size_t num_of_pages;
